...
<div class="space-y-6">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">Edit informasi produk {{ $product->name }}</p>
    </div>

    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('gudang.products.update', $product) }}" method="POST" class="px-4 py-5 sm:p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $product->price) }}" min="0" step="100" required
