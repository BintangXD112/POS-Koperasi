    ...
    <div class="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-6 text-white">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-green-100 text-sm sm:text-base">Panel kasir - Kelola transaksi dan layanan pelanggan</p>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-gray-900">{{ $todayTransactions }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1 min-w-0">
                        <dl>
                            ...
                            <dd class="text-2xl font-bold text-green-600">Aktif</dd>
                        </dl>
                    </div>
                </div>
            </div>
